...
function Clientes({cliente, setClientes}) {
  ...
  return (
    <>
        ...
        <td className='p-2'>
            ...
            <button type='button' className='bg-blue-600 hover:bg-blue-700 p-2  text-white w-full block uppercase font-bold text-xs mt-2'>Editar</button>
            <button type='button' className='bg-red-600 mt-2 hover:bg-red-700 p-2 text-white w-full block uppercase font-bold text-xs'>Eliminar</button>
        </td>
    </tr>
    </>
  )
